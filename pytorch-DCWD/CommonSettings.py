...
parser.add_argument('--batchSize',type=int,default=2,metavar='batchSize',help='input the batch size of training process.(default=64)')
...
parser.add_argument('--n_labels',type=int,default=2,help='the number of sources and target labels')
...
parser.add_argument('--Omega',type=float,default=100000000,help='the hyperparameter')
parser.add_argument('--rat_labeled',type=float,default=0.1,help='the ratio of labeled target data')
...
parser.add_argument('--numClass',default=2,type=int,help='the number of classes')
...
datasetRootAndImageSize=[
    ...
    [[r"E:\transferlearning\data\office_caltech_10\amazon",
      r"E:\transferlearning\data\office_caltech_10\dslr",
