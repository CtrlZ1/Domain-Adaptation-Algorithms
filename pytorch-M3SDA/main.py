...
if __name__ == '__main__':
    ...
    addamodel=model.M3SDAModel(args).to(DEVICE)

    model.train_process(addamodel, trainLoader,testLoader,DEVICE, datasetRootAndImageSize[args.datasetIndex][2],
                        len(datasetRootAndImageSize[args.datasetIndex][0]),args)
