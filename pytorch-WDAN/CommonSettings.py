...
parser.add_argument('--lr',type=float,default=5e-3,metavar='LR',help='the learning rate for training.(default=1e-2)')
...
parser.add_argument('--gamma',type=float,default=0.1,help='the parameter used in the process of generating sources and target datas')
parser.add_argument('--lam',type=float,default=0.1)# 0.0001
parser.add_argument('--lam_cls',type=float,default=10)
