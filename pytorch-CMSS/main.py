...
# model parameter
parser.add_argument('--batchSize',type=int,default=16,metavar='batchSize',help='input the batch size of training process.(default=64)')
...
if __name__ == '__main__':
    ...
    addamodel=model.CMSSModel(args).to(DEVICE)

    model.train_process(addamodel, trainLoader,testLoader,DEVICE, datasetRootAndImageSize[args.datasetIndex][2],args)
