...
# Yb：[n_samples_source,n_labels],if source sample i's label equals j,then Yb[ij]=1,else =0
# Y：[n_samples_source,n_labels],if source sample i's label equals j,then Yb[ij]=1,else =-1
...
#kernal matrix (n_samples_X, n_samples_X)
K=classif.rbf_kernel(X,X,gamma=gamma)

# Yb：[n_samples_x,n_labels],if source sample i's label equals j,then Yb[ij]=1,else =0
