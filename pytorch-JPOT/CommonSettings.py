...
parser.add_argument('--epoch',type=int, default=2,metavar='epoch',help='the number of epochs for training.(default=100)')
...
parser.add_argument('--n_labels',type=int,default=6,help='the number of sources and target labels')
...
parser.add_argument('--backbone_name',type=str,default='LeNet')
...
parser.add_argument('--datasetIndex',type=int,default=6,help='chose the index of dataset by it')
